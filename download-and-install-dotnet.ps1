...
.\dotnet-install.ps1 -Runtime dotnet -Channel 8.0 -Quality GA -InstallDir "C:\Program Files\dotnet"
.\dotnet-install.ps1 -Runtime aspnetcore -Channel 8.0 -Quality GA -InstallDir "C:\Program Files\dotnet"
